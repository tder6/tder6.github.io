changeSize = function() {
    ...
    var titleHeight = window.getComputedStyle(document.getElementsByClassName("text")[1]).height;
    var textHeight;
    if(document.getElementById("markdown") != undefined) textHeight = window.getComputedStyle(document.getElementById("markdown")).height;
    else textHeight = "0px";
    var titleHeightNumber = Number(titleHeight.substr(0, titleHeight.length - 2));
    var textHeightNumber = Number(textHeight.substr(0, textHeight.length - 2));
